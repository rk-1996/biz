...
import { Form, Input, Row, Col, Button, Select, Steps, Checkbox, InputNumber } from "antd";
...
const TaxDetails = (props) => {
  ...
  useEffect(() => {
    setFieldsValue({
      federalFilingStatus: formValues.fedral ? formValues.fedral.filingStatus : "",
      deduction: formValues.fedral ? formValues.fedral.deduction : "",
      dependent: formValues.fedral ? formValues.fedral.dependent : "",
      extraWithHolding: formValues.fedral ? formValues.fedral.extraWithHolding : "",
      ...
      additionalWitholding: formValues.state ? formValues.state.extraWithHolding : "",
      withHoldingAllowances: formValues.state ? formValues.state.withHoldingAllowances : "",
    });
    if (formValues.fedral && formValues.fedral.filingStatus === "Exempt from Witholding") {
      ...
      if (!err) {
        const newObj = {
          ...
          state: {
            ...
            withHoldingAllowances: values.withHoldingAllowances && values.withHoldingAllowances.toString(),
          }
        }
        completedStep({
          ...newObj
