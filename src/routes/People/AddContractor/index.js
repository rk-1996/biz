...
const AddContractor = (props) => {
  ...
  const { addContractorRequest, token, activeLocation, activeCompany, loader, jobs, departments, companies } = props;
  ...
  const onFinish = (data) => {
    ...
    const contractorObj = {
      ...
      phone: formValues.phone ? Number(formValues.phone) : "",
      dob: formValues.dob ? new Date(moment(formValues.dob._d).format("YYYY-MM-DD")).toISOString() : null,
      address: {
